...
We can see that there is periodic variation in the data with a period of approximately 80,000 seconds, <i>i.e.</i> one day. We are looking at a two-day data set. The legitimate transactions follow this periodicity fairly well, but we can't really tell any information about the period of fraudulent cases since there are so few of them.
