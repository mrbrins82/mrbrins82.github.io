...
We only had 138 job listings for which a salary was given, so it's difficult to really get an idea as to what kinds of correlations the other features might have to salary such as company size and rating. When we compared the average salary in our analysis to what a quick Google search yields, our results were a little below when only considering our _MeanSalary_ values. Our _HighSalary_ feature was more in line with what Google says. When considering that our salary information might not take into account other types of compensation such as stocks and bonuses, our figures might actually be in line with Google's results. There was also no distinguishable difference between salary in east coast jobs vs. west coast jobs, though it could be helpful to know what the cost of living is in each of the major cities.
