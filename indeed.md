...
<br/>
# [](#header-2)IV. Summary
Big companies like Apple, Google, Uber, and Twitter are hiring in greater numbers than most other companies, and among these companies there tend to be more job listings for artificial intelligence than for data science or machine learning. However, Data Scientist seems to be the most common job title. I believe that this is due mostly to the fact that data science is more of a household term nowadays, and so it's likely that this title is being applied as a blanket job title for a variety of positions. 

Some of the more popular job skills that we saw included deep learning. Job seekers would be well advised to brush up on neural networks, natural language processing, computer vision, as well as speech recognition. We also saw that data mining is an in demand skill that employers are looking for. Employers are also looking for people with experience in Python and SQL languages.

The majority of companies in this analysis were smaller sized companies. It was difficult to tell if there was any relationship between employee satisfaction and company size, though most companies were in the 3-5 star range. So overall, morale doesn't seem to be much of a problem.

Job location is limited mostly to the coastal regions of the US, however in the east jobs are a bit more spread out and further inland. In the west, jobs are concentrated mostly in San Francisco, Los Angeles, and Seattle. Many of the states in the western half of the country have few to no jobs at all.

We only had 138 out of 2775 job listings for which a salary was given, so it's difficult to really get an idea as to what kinds of correlations the other features might have to salary such as company size and rating. When we compared the average salary in our analysis (~$106k/yr) to what a quick Google search yields(~$123k/yr), our results were a little below when only considering our _MeanSalary_ values. Our average _HighSalary_ feature (~$122k/yr) was more in line with what Google says. When considering that our salary information might not take into account other types of compensation such as stocks and bonuses, our figures might actually be in line with Google's results. There was also no distinguishable difference between salary in east coast jobs vs. west coast jobs, though it could be helpful to know what the cost of living is in each of the major cities.
